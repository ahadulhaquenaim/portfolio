...
export const PALETTES: Record<ThemeName, Palette> = {
  ...
  solo: {
    ...
    heroVideo:
      `${import.meta.env.BASE_URL}videos/hero-character.mp4`,
    heroVideoStyle: {
      objectFit: "contain",
    ...
    sportsVideo:
      `${import.meta.env.BASE_URL}videos/dungeon.mp4`,
    contactVideo:
      `${import.meta.env.BASE_URL}videos/meet.mp4`,
  },
  ...
  dbz: {
    ...
    heroVideo:
      `${import.meta.env.BASE_URL}videos/turning-goku.mp4`,
    heroVideoStyle: {
      objectFit: "contain",
    ...
    contactVideo:
      `${import.meta.env.BASE_URL}videos/sports-animation.mp4`,
  },
};
