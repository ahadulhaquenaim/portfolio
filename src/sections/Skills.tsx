...
const CATEGORIES = [
  ...
  { label: "AI & Data Processing",     names: ["LLM Integration", "Prompt Engineering", "RAG", "LangChain / LangGraph", "Vector Databases", "Claude (Anthropic)", "n8n Workflow", "Apache Airflow", "ETL Pipelines", "Pandas / BeautifulSoup4"] },
];
